...
# --- 1. SILENCE THE NOISE ---
# This turns off the standard Flask logs (the "garbage" you saw)
...
def receive_keys():
    ...
    if data:
        ...
        # --- 2. THE CLEAN OUTPUT ---
        # This will be the ONLY thing printed to your terminal
...
if __name__ == '__main__':
    # We turn off the debug banner too for a cleaner look
